<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/FacultyMst.Master" AutoEventWireup="true" CodeBehind="StudentAttendancedetails.aspx.cs" Inherits="CollegeManagement_System.Faculty.StudentAttendancedetails" %>
        ...
        <div class="container p-md-4 p-sm-4">
            ...
            <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
                <div class="col-md-6">
                    ...
                    <asp:TextBox ID="txtroll" runat="server" CssClass="form-control"  placeholder="Enter Student Enrollment Number"></asp:TextBox>
