<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMst.Master" AutoEventWireup="true" CodeBehind="Student.aspx.cs" Inherits="CollegeManagement_System.Admin.Student" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style ="background-image: url('../Image/bg2.jpg');width:100%;height:720px;background-repeat:no-repeat;background-size:cover;background-attachment:fixed;">
        <div class ="container p-md-4 p-sm-4">
            ...
            <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
                <div class="col-md-6">
                    <label for="txtAddmin">Enrollment Number</label>
                    <asp:TextBox ID="txtAddmin" runat="server" CssClass="form-control" placeholder="Enter Enrollment Number"  required>
                   </asp:TextBox>
                  </div>
                <div class="col-md-6">
            ...
            <div class="row mb-3 mr-lg-5 ml-lg-5">
                <div class="col-md-12">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" EmptyDataText="No Record to Display!" 
                        AutoGenerateColumns="False" AllowPaging="True" PageSize="4" OnPageIndexChanging="GridView1_PageIndexChanging" DataKeyNames="Enrollment_Number"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Enrollment Number">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtAddmin" runat="server" Text='<%# Eval("addmin_no") %>' CssClass="form-control" Width="100px">
                                    </asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblEnroll" runat="server" Text='<%# Eval("addmin_no") %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Class">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lblClass" runat="server" Text='<%# Eval("Course_Name") %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
